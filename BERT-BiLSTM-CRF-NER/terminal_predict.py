...
with graph.as_default():
    ...
    (total_loss, logits, trans, pred_ids) = create_model(
        bert_config=bert_config, is_training=False, input_ids=input_ids_p, input_mask=input_mask_p, segment_ids=segment_ids_p,
        labels=label_ids_p, num_labels=num_labels, use_one_hot_embeddings=False)
